...
const palavras = ["The Legend of Zelda: Breath of the Wild", "Super Mario Odyssey", "Red Dead Redemption 2", "The Witcher 3: Wild Hunt", "God of War", "Minecraft", "Fortnite", "Grand Theft Auto V", "Animal Crossing: New Horizons", "Cyberpunk 2077", "Horizon Zero Dawn", "Spider-Man: Miles Morales", "Among Us", "Fall Guys", "Dark Souls III", "Sekiro: Shadows Die Twice", "Assassin's Creed Valhalla", "Doom Eternal", "Resident Evil Village", "Call of Duty: Warzone", "Apex Legends", "Overwatch", "The Elder Scrolls V: Skyrim", "Final Fantasy VII Remake", "Persona 5 Royal", "Hades", "Ghost of Tsushima", "Bloodborne", "Celeste", "Hollow Knight", "Stardew Valley", "Terraria", "League of Legends", "Dota 2", "Valorant", "Rocket League", "FIFA 21", "NBA 2K21", "Madden NFL 21", "The Sims 4", "World of Warcraft", "Diablo III", "Star Wars Jedi: Fallen Order", "Genshin Impact", "Borderlands 3", "Monster Hunter: World", "Control", "Death Stranding", "Nier: Automata", "Metro Exodus"];
...
const tentarLetra = (letra) => {
  ...
  if (ganhou) {
    ...
    setJogoTerminou(true);
    setPalavraDisplay(palavraFormatada);
  }
};
